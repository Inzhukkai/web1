...
| :--- | :--- |
| **Inzhu Abdirasul** | **Lead Makeup Artist** — Responsible for the Home page (`index.html`) and Makeup page (`makeup.html`). |
| **Assylzhan Kishibayeva** | **Beauty Specialist** — Responsible for the Products page (`products.html`) and Tips page (`tips.html`). |
| **Uldanay Bazarbay** | **Creative Director** — Responsible for the Team page (`team.html`) and Contact page (`contact.html`). |
